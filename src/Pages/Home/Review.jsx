    ...
    <div className="mt-8 grid grid-cols-1 gap-x-16 gap-y-12 lg:grid-cols-2">
      <blockquote>
        <header className="sm:flex sm:items-center sm:gap-4">
          ...
          <p className="mt-2 font-medium sm:mt-0">Good quality products</p>
        </header>

        <p className="mt-2 text-gray-700">
       
           Quick delivery, great quality
        tasty homage product just wish prices where betterThe Best online market in the UK. Best services, best products, best customer services. Highly recommended.
        </p>
